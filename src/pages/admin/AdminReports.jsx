...
import { HiChevronLeft, HiTrendingUp, HiCheckCircle, HiX, HiCurrencyRupee } from 'react-icons/hi';
...
export default function AdminReports() {
  ...
  const METRICS = [
    { Icon: HiTrendingUp,     label: 'Total Bookings',  val: orders.length,              color: '#3b82f6' },
    ...
    { Icon: HiCurrencyRupee,  label: 'Avg Booking Value', val: `₹${avgOrder.toLocaleString()}`, color: '#f59e0b' },
    ...
    <div className="admin-page">
      <div className="admin-header">
        <div className="ah-with-back">
          ...
          <div><h1>Booking Reports</h1><p>Analytics and editor performance overview</p></div>
        </div>
      </div>
      ...
      <div className="reports-grid">
        ...
        <div className="admin-section">
          <div className="as-header"><h2>Top Editors</h2></div>
            ...
            <div className="top-list">
              {topWorkers.map((w, i) => (
                <div key={w.id} className="top-item">
                  ...
                  <span className="top-count">{w.jobs} projects</span>
                </div>
              ))}
            </div>
          )}
